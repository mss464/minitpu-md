...
HD_PWD='/home/mss464/minitpu/tpu/ultra96-v2/output/tpu_system/tpu_system.runs/minitpu_tpu_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log minitpu_tpu_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source minitpu_tpu_0_0.tcl
